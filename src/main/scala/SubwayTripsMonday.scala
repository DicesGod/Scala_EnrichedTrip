...
object SubwayTripsMonday extends App{
  ...
  val enrichedSubwayTripsMondays = tripRoute.lookupRouteTripTable.collect{ case (service_id,route_id,trip_id,tripRoute)
  ...
  val subwayTripsMonday = enrichedSubwayTripsMondays.map(x => (x._4._2.route_type,x._5.monday,
    x._4._1.route_id+","
      +x._4._1.service_id+","
      +x._4._1.trip_id+","
  ...
  subwayTripsMonday.foreach(println)

  val outputFile = new BufferedWriter(new FileWriter("/Users/minhle/Desktop/Projects/scala-project1/gtfs_stm/subwayTripsMonday.csv"))
  ...
  val ListSubwayTripsMondays = csvFields.mkString(",") + "\n" + subwayTripsMonday.mkString("\n")
    .replace("(", "")
    .replace(")","")
